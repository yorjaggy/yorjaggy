...
- 🌱 I’m currently building with **Cloudflare, serverless, k8s, clean architecture, TypeScript, and other awesome stuff**

- 🔥 Creator of [urfired.lol](https://urfired.lol), a meme website for making fun of the current tech ecosystem

- 👯 As an AWS Community Builder, I’m looking to collaborate with **content creators and people currently learning how to code**

- 🖥️ I run a **homelab k3s cluster** on two mini PCs (HP EliteDesk 705 G3 + Lenovo ThinkCentre M720q) with Cloudflare tunnels and Traefik for ingress — because why pay for infrastructure when you can overcomplicate it at home?

- 🤝 I’m happy to help with **any Python or Cloud project**

- 📝 I regularly write articles on [https://dev.to/yorjaggy](https://dev.to/yorjaggy)

- 💬 Ask me about **Docker, AWS, Jenkins, Python, Cloudflare, DevOps, Serverless, migrating from on-prem to Cloud**

- 📫 How to reach me **yorjaggy, all over the internet**
